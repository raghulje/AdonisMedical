...
module.exports = (sequelize, DataTypes) => {
  const AboutPageContent = sequelize.define(
    "AboutPageContent",
    {
      ...
      overviewImageOverlayText: { type: DataTypes.TEXT, allowNull: true },
      ...
      globalReachHeading: { type: DataTypes.STRING(255), allowNull: true },
    },
    {
  ...
  AboutPageContent.associate = function (models) {
    ...
    AboutPageContent.belongsTo(models.Media, { foreignKey: 'backgroundImageId', as: 'backgroundImage' });
