...
CREATE TABLE `email_settings` (
  ...
  `contact_form_email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Email to receive contact form submissions',
  `request_demo_email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Email to receive request demo form submissions',
  `is_active` tinyint(1) DEFAULT '1',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
...
INSERT INTO `email_settings` VALUES (1,'smtp.gmail.com',587,'info@refex.co.in','ysux xnwy khzu bgpr','tls','raghul.je@refex.co.in','Adonis Medical','sathishkumar.r@refex.co.in','murugesh.k@refex.co.in',1,'2026-01-20 10:58:35','2026-01-20 11:34:54');
...
INSERT INTO `hf_fixed_hospitals` VALUES (1,'Hospital Name','City name','State name',1007,0,1,'2026-01-21 10:37:42','2026-01-21 10:37:42');
...
CREATE TABLE `home_contact_section` (
  ...
  PRIMARY KEY (`id`),
  KEY `image_id` (`image_id`),
  KEY `home_contact_section_background_image_id_foreign_idx` (`background_image_id`),
  CONSTRAINT `home_contact_section_background_image_id_foreign_idx` FOREIGN KEY (`background_image_id`) REFERENCES `media` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
--
-- Table structure for table `hospitals_served`
--

DROP TABLE IF EXISTS `hospitals_served`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hospitals_served` (
  `id` int NOT NULL AUTO_INCREMENT,
  `hospital_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `city_state` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Format: "City name, State name"',
  `order_index` int NOT NULL DEFAULT '0',
  `is_active` tinyint(1) DEFAULT '1',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
--
-- Dumping data for table `hospitals_served`
--

LOCK TABLES `hospitals_served` WRITE;
/*!40000 ALTER TABLE `hospitals_served` DISABLE KEYS */;
INSERT INTO `hospitals_served` VALUES (1,'Hospital Name','City name, State name',0,1,'2026-01-21 11:26:10','2026-01-21 11:26:10'),(2,'Hospital Name','City name, State name',1,1,'2026-01-21 11:26:10','2026-01-21 11:26:10'),(3,'Hospital Name','City name, State name',2,1,'2026-01-21 11:26:10','2026-01-21 11:26:10'),(4,'Hospital Name','City name, State name',3,1,'2026-01-21 11:26:10','2026-01-21 11:26:10');
/*!40000 ALTER TABLE `hospitals_served` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `hospitals_served_section_settings`
--

DROP TABLE IF EXISTS `hospitals_served_section_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hospitals_served_section_settings` (
  `id` int NOT NULL AUTO_INCREMENT,
  `background_image_id` int DEFAULT NULL COMMENT 'Background SVG/image for the section',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `background_image_id` (`background_image_id`),
  CONSTRAINT `hospitals_served_section_settings_ibfk_1` FOREIGN KEY (`background_image_id`) REFERENCES `media` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `hospitals_served_section_settings`
--

LOCK TABLES `hospitals_served_section_settings` WRITE;
/*!40000 ALTER TABLE `hospitals_served_section_settings` DISABLE KEYS */;
INSERT INTO `hospitals_served_section_settings` VALUES (1,1006,'2026-01-21 11:26:10','2026-01-21 11:27:44');
/*!40000 ALTER TABLE `hospitals_served_section_settings` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `login_history` VALUES (1,1,'::1','Mozilla/5.0 (Windows NT; Windows NT 10.0; en-IN) WindowsPowerShell/5.1.26100.7462','2026-01-07 13:53:59'),(2,1,'::1','Mozilla/5.0 (Windows NT; Windows NT 10.0; en-IN) WindowsPowerShell/5.1.26100.7462','2026-01-07 13:54:06'),(3,1,'::1','Mozilla/5.0 (Windows NT; Windows NT 10.0; en-IN) WindowsPowerShell/5.1.26100.7462','2026-01-07 14:06:46'),(4,1,'::1','Mozilla/5.0 (Windows NT; Windows NT 10.0; en-IN) WindowsPowerShell/5.1.26100.7462','2026-01-07 17:35:28'),(5,1,'::1','Mozilla/5.0 (Windows NT; Windows NT 10.0; en-IN) WindowsPowerShell/5.1.26100.7462','2026-01-07 17:36:54'),(6,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36','2026-01-07 17:37:42'),(7,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36','2026-01-08 04:49:41'),(8,2,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36','2026-01-08 09:10:20'),(9,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36','2026-01-08 09:15:52'),(10,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36','2026-01-08 11:09:43'),(11,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36','2026-01-09 06:29:12'),(12,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36','2026-01-09 10:14:59'),(13,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36','2026-01-12 05:45:40'),(14,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36','2026-01-12 07:14:07'),(15,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36','2026-01-14 04:54:46'),(16,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36','2026-01-16 04:55:05'),(17,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36','2026-01-16 05:13:57'),(18,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36','2026-01-16 05:24:10'),(19,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36','2026-01-16 05:51:22'),(20,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36','2026-01-16 09:01:05'),(21,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36','2026-01-17 06:07:46'),(22,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36','2026-01-19 05:37:18'),(23,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36','2026-01-19 10:19:55'),(24,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36','2026-01-20 05:06:32'),(25,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36','2026-01-20 09:54:36'),(26,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36','2026-01-20 11:26:54'),(27,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36','2026-01-21 07:37:56'),(28,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36','2026-01-21 07:57:33'),(29,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36','2026-01-21 08:10:56'),(30,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36','2026-01-23 12:01:35'),(31,1,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.0.0 Safari/537.36','2026-02-17 08:56:00');
...
--
-- Table structure for table `our_products_items`
--

DROP TABLE IF EXISTS `our_products_items`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `our_products_items` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_image_id` int DEFAULT NULL COMMENT 'Main product image',
  `background_image_id` int DEFAULT NULL COMMENT 'Background PNG for product card',
  `internal_link` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Link to internal product page',
  `order_index` int NOT NULL DEFAULT '0',
  `is_active` tinyint(1) DEFAULT '1',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  ...
  KEY `idx_order` (`order_index`),
  KEY `idx_active` (`is_active`),
  CONSTRAINT `our_products_items_ibfk_1` FOREIGN KEY (`product_image_id`) REFERENCES `media` (`id`) ON DELETE SET NULL,
  CONSTRAINT `our_products_items_ibfk_2` FOREIGN KEY (`background_image_id`) REFERENCES `media` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `our_products_items`
--

LOCK TABLES `our_products_items` WRITE;
/*!40000 ALTER TABLE `our_products_items` DISABLE KEYS */;
INSERT INTO `our_products_items` VALUES (1,'HF Mobile',1008,1006,'/products/hf-mobile',0,1,'2026-01-21 10:10:54','2026-01-21 11:52:47'),(2,'HF Fixed',1009,1006,'/products/hf-fixed',1,1,'2026-01-21 10:10:54','2026-01-21 11:53:50'),(3,'0.5K High End HF C-ARM',1010,1006,'/products/1k1k-high-end-hf-c-arm',2,1,'2026-01-21 10:10:54','2026-01-21 11:54:18'),(4,'Line Frequency X-Ray Systems',1016,1006,'/products/line-frequency-x-ray-systems',3,1,'2026-01-21 10:10:54','2026-01-21 12:00:22'),(5,'Digital Radiography',1015,1006,'/products/digital-radiography',4,1,'2026-01-21 10:10:54','2026-01-21 11:58:31'),(6,'Dream Series-Ceiling Suspended',1014,1006,'/products/dream-series-ceiling-suspended',5,1,'2026-01-21 10:10:54','2026-01-21 11:57:39'),(7,'FPD-C-Arm',1013,1006,'/products/fpd-c-arm',6,1,'2026-01-21 10:10:54','2026-01-21 11:57:02');
/*!40000 ALTER TABLE `our_products_items` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `our_products_page_content` (
  ...
  `hero_title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `hero_subtitle` text COLLATE utf8mb4_unicode_ci,
  `section_intro` text COLLATE utf8mb4_unicode_ci COMMENT 'Intro text shown above the products grid',
  `hero_image_id` int DEFAULT NULL,
  `section_background_image_id` int DEFAULT NULL COMMENT 'Background PNG for the products section',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `hero_image_id` (`hero_image_id`),
  KEY `section_background_image_id` (`section_background_image_id`),
  CONSTRAINT `our_products_page_content_ibfk_1` FOREIGN KEY (`hero_image_id`) REFERENCES `media` (`id`) ON DELETE SET NULL,
  CONSTRAINT `our_products_page_content_ibfk_2` FOREIGN KEY (`section_background_image_id`) REFERENCES `media` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `our_products_page_content` VALUES (1,'Our Products',NULL,'We offer a full suite of X-Ray Systems, ranging from portable & fixed X-Ray machines, Digital Surgical C-arm & Digital Radiography system with advanced cutting edge technology and provide industry’s best after sales service & clinical application.',923,1006,'2026-01-12 07:38:36','2026-01-21 11:49:57');
...
INSERT INTO `production_facility_features` VALUES (1,'ri-settings-3-line','Full vertical integration',NULL,1,'2026-01-07 13:45:35',957,1,'2026-02-18 06:11:30'),(2,'ri-flow-chart','Streamlined processes',NULL,2,'2026-01-07 13:45:35',958,1,'2026-02-18 06:11:30'),(3,'ri-shield-check-line','Controlled quality from start to finish',NULL,3,'2026-01-07 13:45:35',959,1,'2026-02-18 06:11:30'),(4,NULL,'Initial Material Inspection:','Every raw material undergoes a thorough inspection.',3,'2026-01-16 11:21:45',NULL,1,'2026-02-18 06:11:30'),(5,NULL,'In-Process Quality Checks:','Multiple checkpoints during production.',4,'2026-01-16 11:21:45',NULL,1,'2026-02-18 06:11:30'),(6,NULL,'Final Testing:','Comprehensive testing in our in-house quality lab.',5,'2026-01-16 11:21:45',NULL,1,'2026-02-18 06:11:30');
...
INSERT INTO `users` VALUES (1,'raghul','raghul.je@refex.co.in','$2b$10$oOLmC7da0LAVCbSCHFGxkekJVo0jtxivdbwhtamRYyDL3ugbSyL3a','Raghul JE','super_admin',1,'2026-02-17 08:56:00',NULL,'2026-01-07 13:53:49','2026-02-17 08:56:00'),(2,'murugesh','murugesh.k@refex.co.in','$2b$10$ZD.slGRTRZDMWn985zVSzeY6wwXC11EQkUq3IamuTBGBuGVUrrgd6','murugesh kumar','super_admin',1,'2026-01-08 09:10:20',NULL,'2026-01-08 06:30:21','2026-01-08 09:10:20');
...
-- Dump completed on 2026-03-30 16:32:18
