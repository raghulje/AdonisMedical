...
export default function HFFixed() {
  ...
  const productName = content?.title || 'HF Fixed X-Ray System';
  const productDescription = content?.description || 'High-frequency stationary X-ray solution for radiology departments. Reliable, efficient, and designed for high-volume imaging.';
  const seoConfig = getSEOConfig('/products/hf-fixed');
