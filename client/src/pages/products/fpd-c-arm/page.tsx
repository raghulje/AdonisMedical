...
export default function FPDCArm() {
  ...
  const productName = content?.title || 'FPD C-Arm System';
  const productDescription = content?.description || 'FPD C-arm system with flat panel detector technology. Advanced fluoroscopy solution for surgical and interventional procedures with superior image quality.';
  const seoConfig = getSEOConfig('/products/fpd-c-arm');
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            ...
            <div className="flex flex-wrap justify-center gap-8">
              {productCards.length > 0 ? (
                productCards
                  .filter(card => card.name !== 'FPD-C-Arm')
                  .map((product, idx) => (
                ...
                [
                  ...
                  { name: '0.5K High End HF C-ARM', img: getDefaultImageUrl('2025/02/02-1-1024x683.jpg'), link: '/products/1k1k-high-end-hf-c-arm' },
