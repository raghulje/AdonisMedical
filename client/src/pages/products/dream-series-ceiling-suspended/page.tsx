...
export default function DreamSeriesCeilingSuspendedPage() {
  ...
  const productName = content?.title || 'Dream Series Ceiling Suspended X-Ray System';
  const productDescription = content?.description || 'Advanced overhead X-ray solution with precision positioning, high image quality, and ergonomic design for modern radiology departments.';
  const seoConfig = getSEOConfig('/products/dream-series-ceiling-suspended');
